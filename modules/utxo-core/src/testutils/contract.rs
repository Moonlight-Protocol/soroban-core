use crate::{
    core::{Bundle, OperationBundle, UtxoHandlerTrait},
    testutils::operation_bundle::calculate_auth_requirements,
};
...
impl UTXOModuleTestContract {
    ...
    pub fn transact(e: Env, op: OperationBundle) {
    ...
    pub fn transact_with_external(
        ...
        let req = calculate_auth_requirements(&e, &op.spend);
