...
// use moonlight_auth::SignerKey;
// use moonlight_utxo_core::tests::helpers::{create_contract, TestContractClient};
// use soroban_sdk::{
//     contract, contracterror, contractimpl, contracttype, symbol_short,
//     testutils::Address as TestAddress, vec, Address, BytesN, Env, TryIntoVal, Val, Vec,
// };

// use crate::contract::{UTXOAuthContract, UTXOAuthContractArgs, UTXOAuthContractClient};
...
//     let mock_utxo_contract_client = create_contract(e, auth_contract_address);
